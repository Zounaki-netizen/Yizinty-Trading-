...
import { ChatAttachment } from "../../services/geminiService";
  ...
  ({ className, containerClassName, showRing = true, ...props }, ref) => {
    ...
    return (
      <div className={cn(
        ...
        {showRing && isFocused && (
          <motion.span 
            className="absolute inset-0 rounded-md pointer-events-none ring-2 ring-offset-0 ring-brand-500/30"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        {props.onChange && (
          <div 
            className="absolute bottom-2 right-2 opacity-0 w-2 h-2 bg-brand-500 rounded-full"
            style={{
              animation: 'none',
            }}
            id="textarea-ripple"
...
export function AnimatedAIChat({ onSendMessage }: Props) {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        { 
            ...
            label: "Analyze Chart", 
            description: "Analyze price action from screenshot", 
            prefix: "/analyze" 
        },
        { 
            icon: <FileUp className="w-4 h-4" />, 
            label: "Journal Entry", 
            description: "Log a new trade via chat", 
            prefix: "/journal" 
        },
        { 
        ...
        { 
            ...
            label: "Psychology", 
            description: "Get mindset coaching", 
            prefix: "/mentor" 
        },
    ];
    ...
    const handleSendMessage = () => {
        if (value.trim() || attachments.length > 0) {
            setIsTyping(true);
            // Simulate a small delay for effect, then call prop
            setTimeout(() => {
    ...
    return (
        <div className="h-full flex flex-col w-full items-center justify-center bg-transparent text-white p-6 relative overflow-hidden min-h-[600px]">
            {/* Background Ambience */}
                    ...
                    <div className="text-center space-y-3">
                        ...
                        >
                            <h1 className="text-3xl font-medium tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white/90 to-white/40 pb-1">
                                ICT Engine: How can I help?
                            </h1>
                            <motion.div 
                                className="h-px bg-gradient-to-r from-transparent via-brand-500/40 to-transparent"
                        ...
                        >
                            Ask about psychology, setups, or risk management
                        </motion.p>
                    </div>
            ...
            {inputFocused && (
                <motion.div 
                    className="fixed w-[50rem] h-[50rem] rounded-full pointer-events-none z-0 opacity-[0.02] bg-gradient-to-r from-brand-500 via-orange-500 to-yellow-500 blur-[96px]"
                    animate={{
