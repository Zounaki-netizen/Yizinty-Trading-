  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#050505] relative overflow-hidden p-4">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-brand-500/10 rounded-full mix-blend-normal filter blur-[80px] md:blur-[128px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-orange-600/5 rounded-full mix-blend-normal filter blur-[80px] md:blur-[128px] animate-pulse delay-700" />
      </div>
      ...
      >
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-white/40 text-sm font-medium">Professional Trading Intelligence</p>
        </div>

        <div className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.05] p-6 md:p-8 rounded-2xl shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <p className="text-white/40 text-xs mt-1">Enter your credentials to access the terminal.</p>
          </div>
